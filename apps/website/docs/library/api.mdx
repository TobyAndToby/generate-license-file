---
title: API
description: API reference documentation for the generate license file library API
---
  ...
  methodData={{
    ...
    signatures: [
        ...
        params: [
          {
            ...
            type: "string",
            description: "A path to the package.json for the project. The file must be named package.json",
          },
          {
            name: "outputPath",
            type: "string",
      ...
      },
      {
        params: [
          {
            name: "pathsToPackageJsons",
            type: "string[]",
            description: "Paths to the package.jsons for the projects. Each file must be named package.json",
          },
          {
            name: "outputPath",
            type: "string",
