"use strict";(self.webpackChunk_generate_license_file_website=self.webpackChunk_generate_license_file_website||[]).push([[312],{9411:(e,t,n)=>{n.d(t,{R:()=>c,Z:()=>p});var i=n(3786),r=n(8583),a=n(5495),o=n(7294),s=n(888);const l=(0,a.O4)("showTypeScript",!0),c=()=>(0,r.Dv)(l),p=()=>{const[e,t]=(0,r.KO)(l);return o.createElement("form",null,o.createElement(d,{htmlFor:"show-typescript"},o.createElement(m,null,"Language:"),o.createElement(s.Z,{id:"show-typescript",icons:{checked:o.createElement(g,{color:"white"},"TS"),unchecked:o.createElement(g,{color:"black"},"JS")},checked:e,onChange:e=>t(e.target.checked)})))},d=i.Z.label`
  display: flex;
  align-items: center;
...
`,g=i.Z.span`
  ...
  font-size: 14px;
  padding-top: 2px;
`},4629:(e,t,n)=>{n.d(t,{Z:()=>o});var i=n(3786),r=n(7294),a=n(3774);const o=e=>{let{methodData:t}=e;const{name:n,signatures:i}=t,[o,d]=(0,r.useState)(0),m=i[o];return r.createElement(r.Fragment,null,i.length>1&&r.createElement(s,null,r.createElement(l,null,r.createElement("button",{onClick:()=>d(c(i.length))},r.createElement("img",{src:"/img/chevron-down-outline.svg"})),r.createElement("button",{onClick:()=>d(p(i.length))},r.createElement("img",{src:"/img/chevron-up-outline.svg"}))),r.createElement("span",null,"Overload ",o+1," of ",i.length)),r.createElement(a.Z,{methodName:n,signature:m}))},s=i.Z.div`
  display: flex;
  align-items: center;
  margin-bottom: 1em;
`,l=i.Z.span`
