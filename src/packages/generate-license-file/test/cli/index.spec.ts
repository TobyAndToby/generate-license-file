...
import { ArgumentsWithAliases, argumentsWithAliases } from "../../src/lib/cli/cli-arguments";
import { main } from "../../src/lib/cli/index";
...
jest.mock("../../src/lib/generateLicenseFile", () => ({
...
jest.mock("../../src/lib/cli/args/output.ts", () => ({
  Output: function () {
    return { parse: mockOutputParse, resolve: mockOutputResolve };
  },
}));

jest.mock("../../src/lib/cli/args/eol.ts", () => ({
  Eol: function () {
    return { parse: mockEolParse, resolve: mockEolResolve };
  },
}));

jest.mock("../../src/lib/cli/args/no-spinner.ts", () => ({
  NoSpinner: function () {
