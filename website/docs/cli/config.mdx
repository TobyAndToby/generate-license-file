...
The append option allows you to append files to the end of the generated output file. This is useful if you project
...
accidentally lists one of it's own dev-dependencies as a normal dependency and you want to exluce that dev-dependency.
