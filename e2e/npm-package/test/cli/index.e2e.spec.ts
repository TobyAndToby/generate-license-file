  ...
  describeRelativeAndAbsolutePaths("./package.json", (packageJsonPath) => {
    ...
    describe("overwrite", () => {
      it("should overwrite the file if --overwrite is given", async () => {
        ...
        await execAsync(`npx generate-license-file --input ${input} --output ${output} --overwrite`);
    ...
    describeEachLineEnding((lineEnding, lineEndingLiteral) => {
      ...
      it("should match snapshot when --eol is given", async () => {
        await execAsync(`npx generate-license-file --input ${input} --output ${output} --eol ${lineEnding}`);
    ...
    describe("no-spinner", () => {
      it("should match snapshot when --no-spinner is given", async () => {
        await execAsync(`npx generate-license-file --input ${input} --output ${output} --no-spinner`);
    ...
    describe("omit-versions", () => {
      it("should match snapshot when --omit-versions is given", async () => {
        await execAsync(`npx generate-license-file --input ${input} --output ${output} --omit-versions`);
