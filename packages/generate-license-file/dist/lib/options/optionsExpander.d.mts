//#region src/lib/options/optionsExpander.d.ts
/**
 ...
 */
type IntersectionExpander<T> = T extends ((...args: infer A) => infer R) ? (...args: IntersectionExpander<A>) => IntersectionExpander<R> : T extends infer O ? { [K in keyof O]: O[K] } : never;
//#endregion
export { IntersectionExpander };